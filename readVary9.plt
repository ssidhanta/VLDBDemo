...
set output 'readVary9.eps'
#set y2range [0:15]
#set y2tics nomirror
#set ytics nomirror
plot 'trainingdataout.csv' every 5 using 1:20 title 'Latency with ONE READ/ANY WRITE' with linespoints pointtype 7  pointsize 2; 
#plot 'trainingdataout.csv' every 5 using 1:21 title 'Staleness with ONE READ/ANY WRITE' with linespoints pointsize 2  axes x1y2,'trainingdataout.csv' every 5 using 1:20 title 'Latency with ONE READ/ANY WRITE' with linespoints pointtype 7  pointsize 2  axes x1y1; 