...
#plot 'training_data.csv' every 100 using 1:9 title 'Staleness with ONE READ/ANY WRITE'  with linespoints pt 1  pointsize 2 axes x1y2,'training_data.csv' every 100 using 1:8 title 'Latency with ONE READ/ANY WRITE' with linespoints pt 2  pointsize 2 axes x1y1, 'training_data.csv' every 100 using 1:11 title 'Staleness with QUORUM READ/WRITE' with linespoints pt 3  pointsize 2 axes x1y2,'training_data.csv' every 100 using 1:10 title 'Latency with QUORUM READ/WRITE' with linespoints pt 4  pointsize 2 axes x1y1, 'training_data.csv' every 100 using 1:13 title 'Staleness with ALL READ/QUORUM WRITE' with linespoints pt 5  pointsize 2 axes x1y2,'training_data.csv' every 100 using 1:12 title 'Latency with ALL READ/QUORUM WRITE' with linespoints pt 6  pointsize 2 axes x1y1;